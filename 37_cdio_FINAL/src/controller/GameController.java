...
public class GameController {
 ...
 GUI.getUserButtonPressed("afsoner eller betale", "betal", "3 rundt");
	...
	public void setupGame() {
		...
		ChanceCard[] cards = {
			new MoneyCard(300, "Du vinder i lotto, modtag kr. 3 00,-"),
		...
		fields = new Field[] { 
				...
				new Property("Gl.kongevej", new int[]{400, 1000, 1400, 1800, 2200, 2600 }, 2600, 6000, 6), 
				new Shipping("CM port", 4000),
				new Property("Bernstorffsvej", new int[]{400, 1100, 1500, 1900, 2300, 2700 }, 2700, 6200, 3),
				new Chance("lykke3", 3, cards),
				new Property("Hellerupsvej", new int[]{400, 1100, 1500, 1900, 2300, 2700 }, 2700, 7000, 3),
				new Property("Strandvej", new int[]{500, 1200, 1600, 2000, 2400, 2800 }, 2800, 7500, 3),
